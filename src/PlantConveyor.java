...
public class PlantConveyor extends ClockDomain{
  ...
  private int S14198 = 1;
  private int S12574 = 1;
  private int S12491 = 1;
  private int S12741 = 1;
  private int S12629 = 1;
  private int S12601 = 1;
  private int S12600 = 1;
  private int S12818 = 1;
  private int S12766 = 1;
  private int S12742 = 1;
  private int S12880 = 1;
  private int S12823 = 1;
  private int S12906 = 1;
  private int S12888 = 1;
  private int S12896 = 1;
  private int S12904 = 1;
  ...
  public void thread14214(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest14218 = 0;
        if(ends[7]>=biggest14218){
          biggest14218=ends[7];
        }
        if(ends[8]>=biggest14218){
          biggest14218=ends[8];
        }
        if(ends[9]>=biggest14218){
          biggest14218=ends[9];
        }
        if(biggest14218 == 1){
          active[6]=1;
  ...
  public void thread14204(int [] tdone, int [] ends){
    ...
    int biggest14208 = 0;
    if(ends[7]>=biggest14208){
      biggest14208=ends[7];
    }
    if(ends[8]>=biggest14208){
      biggest14208=ends[8];
    }
    if(ends[9]>=biggest14208){
      biggest14208=ends[9];
    }
    if(biggest14208 == 1){
      active[6]=1;
  ...
  public void thread14202(int [] tdone, int [] ends){
        S12818=1;
    S12766=0;
    bottlePos_1.setPresent();//sysj\plantConveyor.sysj line: 70, column: 6
    currsigs.addElement(bottlePos_1);
  ...
  public void thread14201(int [] tdone, int [] ends){
        S12741=1;
    data_thread_3 = (bottlePos_1.getpreval() == null ? 0 : ((Integer)bottlePos_1.getpreval()).intValue());//sysj\plantConveyor.sysj line: 36, column: 3
    S12629=0;
    if((Integer)(bottlePos_1.getpreval() == null ? 0 : ((Integer)bottlePos_1.getpreval()).intValue()) == 0){//sysj\plantConveyor.sysj line: 37, column: 7
    ...
    RUN: while(true){
      switch(S14198){
        ...
        case 1 : 
          ...
          thread14201(tdone,ends);
          thread14202(tdone,ends);
          thread14203(tdone,ends);
          thread14204(tdone,ends);
          int biggest14209 = 0;
          if(ends[2]>=biggest14209){
            biggest14209=ends[2];
          }
          if(ends[3]>=biggest14209){
            biggest14209=ends[3];
          }
          if(ends[4]>=biggest14209){
            biggest14209=ends[4];
          }
          if(ends[5]>=biggest14209){
            biggest14209=ends[5];
          }
          if(ends[6]>=biggest14209){
            biggest14209=ends[6];
          }
          if(biggest14209 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest14219 = 0;
          if(ends[2]>=biggest14219){
            biggest14219=ends[2];
          }
          if(ends[3]>=biggest14219){
            biggest14219=ends[3];
          }
          if(ends[4]>=biggest14219){
            biggest14219=ends[4];
          }
          if(ends[5]>=biggest14219){
            biggest14219=ends[5];
          }
          if(ends[6]>=biggest14219){
            biggest14219=ends[6];
          }
          if(biggest14219 == 1){
            active[1]=1;
