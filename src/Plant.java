...
public class Plant extends ClockDomain{
  ...
  public void thread1681(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest1688 = 0;
        if(ends[8]>=biggest1688){
          biggest1688=ends[8];
        }
        if(ends[9]>=biggest1688){
          biggest1688=ends[9];
        }
        if(ends[10]>=biggest1688){
          biggest1688=ends[10];
        }
        if(ends[11]>=biggest1688){
          biggest1688=ends[11];
        }
        if(ends[12]>=biggest1688){
          biggest1688=ends[12];
        }
        if(ends[13]>=biggest1688){
          biggest1688=ends[13];
        }
        if(biggest1688 == 1){
          active[7]=1;
  ...
  public void thread1667(int [] tdone, int [] ends){
    ...
    if(ends[10]>=biggest1674){
      biggest1674=ends[10];
    }
    if(ends[11]>=biggest1674){
      biggest1674=ends[11];
    }
    if(ends[12]>=biggest1674){
      biggest1674=ends[12];
    }
    if(ends[13]>=biggest1674){
      biggest1674=ends[13];
    }
    if(biggest1674 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S1660){
        ...
        case 1 : 
          ...
          int biggest1675 = 0;
          if(ends[2]>=biggest1675){
            biggest1675=ends[2];
          }
          if(ends[3]>=biggest1675){
            biggest1675=ends[3];
          }
          if(ends[4]>=biggest1675){
            biggest1675=ends[4];
          }
          if(ends[5]>=biggest1675){
            biggest1675=ends[5];
          }
          if(ends[6]>=biggest1675){
            biggest1675=ends[6];
          }
          if(ends[7]>=biggest1675){
            biggest1675=ends[7];
          }
          if(biggest1675 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          if(ends[3]>=biggest1689){
            biggest1689=ends[3];
          }
          if(ends[4]>=biggest1689){
            biggest1689=ends[4];
          }
          if(ends[5]>=biggest1689){
            biggest1689=ends[5];
          }
          if(ends[6]>=biggest1689){
            biggest1689=ends[6];
          }
          if(ends[7]>=biggest1689){
            biggest1689=ends[7];
          }
          if(biggest1689 == 1){
            active[1]=1;
