...
public class RotaryTablePorts {
	public static final String ALIGNEDSENSOR_SIGNAL = "PlantRotaryTableCD.alignedSensor";
	public static final String CAP_AT_POS_1_SIGNAL = "PlantRotaryTableCD.capAtPos1";
